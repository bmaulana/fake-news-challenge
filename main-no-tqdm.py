...
print('\nx_train')
x_train = np.array([to_feature_array(doc) for doc in train_all])
print(x_train[:10])
...
print('x_validation')
x_val = np.array([to_feature_array(doc) for doc in val_all])
print(x_val[:5])
...
x_test = np.array([to_feature_array(doc) for doc in test_all])
print('\nx_test')
print(x_test[:5])
